...
/**
 * Alternatively use JobScheduler - available after Lollipop API21
 * Third-party library: Evernote’s android-job library
 */
public class PollService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        if (!isNetworkAvailableAndConnecter()) {
            return;
        }
    ...
    private boolean isNetworkAvailableAndConnecter() {
